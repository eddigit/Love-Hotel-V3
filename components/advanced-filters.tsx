...
export function AdvancedFilters({ onFilterChange }: AdvancedFiltersProps) {
  ...
  const updateMeetingType = (type: keyof FilterOptions["meetingTypes"], value: boolean) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="outline" size="icon" className="flex-shrink-0 border-purple-800/30 bg-[#2d1155]/50 relative">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-purple-200">{filters.distance} km</span>
            </div>
            <Slider
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="all" id="status-all" className="border-purple-500" />
                <Label htmlFor="status-all" className="text-xs cursor-pointer">
                  Tous
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="single" id="status-single" className="border-purple-500" />
                <Label htmlFor="status-single" className="text-xs cursor-pointer">
                  Célibataires
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="couple" id="status-couple" className="border-purple-500" />
                <Label htmlFor="status-couple" className="text-xs cursor-pointer">
                  Couples
                </Label>
              </div>
            </RadioGroup>
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="all" id="orientation-all" className="border-purple-500" />
                <Label htmlFor="orientation-all" className="text-xs cursor-pointer">
                  Toutes
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="hetero" id="orientation-hetero" className="border-purple-500" />
                <Label htmlFor="orientation-hetero" className="text-xs cursor-pointer">
                  Hétéro
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="homo" id="orientation-homo" className="border-purple-500" />
                <Label htmlFor="orientation-homo" className="text-xs cursor-pointer">
                  Homo
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="bi" id="orientation-bi" className="border-purple-500" />
                <Label htmlFor="orientation-bi" className="text-xs cursor-pointer">
                  Bi
                </Label>
              </div>
            </RadioGroup>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateMeetingType("friendly", checked)}
                  className="data-[state=checked]:bg-[#ff3b8b]"
                />
                <Label htmlFor="type-friendly" className="text-xs cursor-pointer">
                  Amicales
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateMeetingType("romantic", checked)}
                  className="data-[state=checked]:bg-[#ff3b8b]"
                />
                <Label htmlFor="type-romantic" className="text-xs cursor-pointer">
                  Romantiques
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateMeetingType("playful", checked)}
                  className="data-[state=checked]:bg-[#ff3b8b]"
                />
                <Label htmlFor="type-playful" className="text-xs cursor-pointer">
                  Ludiques
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateMeetingType("openCurtains", checked)}
                  className="data-[state=checked]:bg-[#ff3b8b]"
                />
                <Label htmlFor="type-openCurtains" className="text-xs cursor-pointer">
                  Rideaux ouverts
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateMeetingType("libertine", checked)}
                  className="data-[state=checked]:bg-[#ff3b8b]"
                />
                <Label htmlFor="type-libertine" className="text-xs cursor-pointer">
                  Libertines
                </Label>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="all" id="curtain-all" className="border-purple-500" />
                <Label htmlFor="curtain-all" className="text-xs cursor-pointer">
                  Tous
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="open" id="curtain-open" className="border-purple-500" />
                <Label htmlFor="curtain-open" className="text-xs cursor-pointer">
                  Ouvert
                </Label>
              </div>
              <div className="flex items-center space-x-1 rounded-md border border-purple-800/50 p-2 bg-purple-900/20">
                <RadioGroupItem value="closed" id="curtain-closed" className="border-purple-500" />
                <Label htmlFor="curtain-closed" className="text-xs cursor-pointer">
                  Fermé
                </Label>
              </div>
            </RadioGroup>
