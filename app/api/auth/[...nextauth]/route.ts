...
import { verifyUserCredentials, getUserById, getOrCreateOAuthUser, getUserByEmail } from "@/lib/user-service"

// Make sure NEXTAUTH_URL and NEXTAUTH_SECRET are set in your environment variables
